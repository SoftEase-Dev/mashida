...
const Header = () => {
    return (
        <header className="relative">
            <div className="absolute h-[708px] bottom-0 sm:h-screen w-full -z-50">
            ...
            <Container className="h-screen flex w-full justify-center items-center">
                <div className="flex flex-col z-50 items-center w-[80%] relative text-center -mt-40">
                    ...
                    <Text variant="subtitle" className="font-light mt-4">Mashida is comprised of GameFi, SocialFi and NFTFi elements containing a Virtual, Social World and Game application features that are interconnected.</Text>
